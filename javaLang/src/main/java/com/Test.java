...
// 本试卷唯一 ID: A65B2D53F7395374E442E5A3B535711B, 请勿修改本行内容
/* 注意, 这里不要写包名. 留空 */
...
class MetaJavaQuestionSheet {
    ...
    */
    ...
    public static boolean subTreeSymmetric(TreeNode left, TreeNode right) {
        if (left == null && right == null) return true;
        if ( (left == null || right == null) && left != right ) return false;
        return left.val == right.val && subTreeSymmetric(left.left, right.right) && subTreeSymmetric(left.right, right.left);
    }
}